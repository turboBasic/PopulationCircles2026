...
**Status: early.** Grid geometry, spherical geodesy, raster ingest and the summation table with its
on-disk cache are implemented and tested; the kernels and the search itself are not.
